# A MIDI driver to play MIDI using OSX's Audio Unit system
#
# == Authors
#
# * Adam Murray <adam@compusition.com>
# * Simon Hicks <music@simonhicks.org>
#
# == Copyright
#
...
class Scails::MIDIator::Driver::AudioUnit < Scails::MIDIator::Driver # :nodoc:
  ...
  module AudioToolbox
    ...
    #AudioUnitManufacturer          = 'appl'.to_bytes
    AudioUnitType_MusicDevice      = 'aumu'.to_bytes
    #AudioUnitSubType               = 'dls '.to_bytes
  ...
  def open
    ...
    cd.componentManufacturer = AudioToolbox::AudioUnitManufacturer
    cd.componentFlags = 0
    ...
    cd.componentSubType = AudioToolbox::AudioUnitSubType
